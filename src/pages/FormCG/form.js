            ...
            <Form name="Capital de Giro">
                    ...
                    <Col md={12}>
                        <Box m={1} pt={3}>
                            <FormControl fullWidth sx={{ m: 1 }} variant="filled">
                                ...
                                <CurrencyInput2 style={{ backgroundColor: '#F8F9FA' }} type='text' />
                ...
                <Row>
                    <Col md={12}>
                        <Box m={1} pt={3}>
                            <FormControl fullWidth>
                                <TextField onChange={handleChange} style={{ backgroundColor: '#F8F9FA' }} value={values.name} error={!!errors.name} className={classes.root} helperText={errors.name} label='Nome Completo' name='payload.name' type='text' placeholder='Nome Completo' />
                                <ErrorMessage render={msg => <Message>{msg}</Message>} name='payload.name' />
                            </FormControl>
                        </Box>
                    </Col>
                    <Col md={6}>
